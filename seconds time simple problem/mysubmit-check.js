// problem 1: ana to vori
 function anaToVori(anaa){
      if (0 < anaa){ var vori = anaa / 16;
         // one vori = sixteen anaa
                                   ...
                                   // people multiply 5000 it's runing one to hundred 
                                     ...
                                     var totalCost = (people -100) * 4000 + 500000;
                                      // onehundred one to two hundred multiply 4000 with addtion before 500000
                                        ...
                                        return totalCost; 
                                    } // problem 4: function oddFriend(frinendsNames){ if (typeof(frinendsNames) == 'object') // compare input equal object { for(var i = 0; i < frinendsNames.length; i++){ if (frinendsNames[i].length % 2 != 0) // odd length count { var myOddFriend = frinendsNames[i]; break; // when get odd length then loop break } } } else{console.log('please, input array')} return myOddFriend; }